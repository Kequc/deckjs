...
(function() {
  ...
  Deck = (function() {
    ...
    function Deck(opt) {
      ...
      this.spent = bind(this.spent, this);
      this.cards = bind(this.cards, this);
    ...
    Deck.prototype.last = function() {
      return this._spent[this._spent.length - 1] || null;
    };
    ...
    Deck.prototype.draw = function() {
      ...
      card = null;
      if (i > -1) {
        card = this._cards.splice(i, 1)[0] || null;
      }
      if (card) {
        this._spent.push(card);
      }
      return card;
    };
